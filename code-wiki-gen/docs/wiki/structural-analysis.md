...
`code-wiki-gen/src/analysis/scripts/analyze_repository.py` (454 LOC)
...
### `raw-output.ts`
`code-wiki-gen/src/analysis/raw-output.ts` (54 LOC)
...
### `adapter.ts`
`code-wiki-gen/src/analysis/adapter.ts` (151 LOC)
...
### `normalizer.ts`
`code-wiki-gen/src/analysis/normalizer.ts` (418 LOC)
...
### `analyze.ts`
`code-wiki-gen/src/analysis/analyze.ts` (103 LOC)
