...
### Subprocess Runner
**`code-wiki-gen/src/adapters/subprocess.ts`** (79 LOC)
...
### Git CLI Adapter
**`code-wiki-gen/src/adapters/git.ts`** (397 LOC)
...
### GitHub CLI Adapter
**`code-wiki-gen/src/adapters/gh.ts`** (87 LOC)
...
**`code-wiki-gen/src/adapters/python.ts`** (88 LOC)
...
### Agent SDK Adapter
**`code-wiki-gen/src/adapters/agent-sdk.ts`** (254 LOC)
...
All adapters import shared types from the **Type Definitions** module (`code-wiki-gen/src/types/common.ts`, `code-wiki-gen/src/types/index.ts`).
